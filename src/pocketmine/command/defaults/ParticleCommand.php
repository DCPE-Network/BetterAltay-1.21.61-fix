...
class ParticleCommand extends VanillaCommand {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        // Adaptation of PM5 functionality: split data argument into at most 5 parts
        $data = isset($args[8]) ? $args[8] : null;
        if ($data !== null) {
            $dataParts = explode("_", $data, 5);
            $data = count($dataParts) > 1 ? (int)$dataParts[0] : null; // Using first part as data
        }
    ...
    // To preserve the old unlimited explode behavior, allow this to split into at most 5 parts
    $d = explode("_", $name, 5);
    
    // Maintain original functionality with added split logic
